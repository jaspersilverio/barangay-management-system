...
class UpdateIncidentReportRequest extends FormRequest
{
    ...
    {
        return [
            'incident_title' => ['sometimes', 'required', 'string', 'max:255'],
            'description' => ['sometimes', 'required', 'string'],
            'incident_date' => ['sometimes', 'required', 'date_format:Y-m-d', 'before_or_equal:today'],
            'incident_time' => ['sometimes', 'required', 'date_format:H:i'],
            'location' => ['sometimes', 'required', 'string', 'max:255'],
            'persons_involved' => ['nullable', 'string'],
            'reporting_officer_id' => ['sometimes', 'required', 'exists:users,id'],
