...
class UpdateOfficialRequest extends BaseFormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'name' => $isEnhancedCategory ? ['nullable', 'string', 'max:255'] : ['sometimes', 'required', 'string', 'max:255'],
            'category' => ['nullable', 'string', 'in:official,sk,tanod,bhw,staff'],
            // Official and SK category fields
            'first_name' => $isEnhancedCategory ? ['sometimes', 'required', 'string', 'max:255'] : ['nullable', 'string', 'max:255'],
            'middle_name' => ['nullable', 'string', 'max:255'],
            'last_name' => $isEnhancedCategory ? ['sometimes', 'required', 'string', 'max:255'] : ['nullable', 'string', 'max:255'],
