...
<head>
    <meta charset="utf-8">
    <title>Business Permit Endorsement</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        <h2 style="text-align: center; color: #333;">BUSINESS PERMIT ENDORSEMENT</h2>

        <p>TO WHOM IT MAY CONCERN:</p>

        <p>This is to certify that <strong>{{ $resident->full_name }}</strong>,
            of legal age, Filipino, and a resident of {{ $barangay_name }},
            has applied for a business permit endorsement in this barangay.</p>
        ...
        <p>This endorsement is being issued upon the request of the above-named person
            for <strong>{{ $certificate->purpose }}</strong>.</p>

        <p>This endorsement is valid from <strong>{{ $valid_from_formatted }}</strong>
