...
<body>
    ...
    <div class="content">
        <h2 style="text-align: center; color: #333;">BARANGAY CLEARANCE</h2>

        <p>TO WHOM IT MAY CONCERN:</p>

        <p>This is to certify that <strong>{{ $resident->full_name }}</strong>,
            of legal age, Filipino, and a resident of {{ $barangay_name }},
            is a person of good moral character and law-abiding citizen.</p>
        ...
        <p>This clearance is valid from <strong>{{ $valid_from_formatted }}</strong>
