...
<body>
    ...
    <div class="content">
        <h2 style="text-align: center; color: #333;">RESIDENCY CERTIFICATE</h2>

        <p>TO WHOM IT MAY CONCERN:</p>

        <p>This is to certify that <strong>{{ $resident->full_name }}</strong>,
            of legal age, Filipino, is a bonafide resident of {{ $barangay_name }}
            and has been residing in this barangay for a considerable period of time.</p>
