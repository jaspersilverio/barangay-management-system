...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Report content wrapper to avoid full-width text */
        .report-content {
...
<body>
    ...
    @else
        {{-- REPORT LAYOUT (uses barangay logo centered, no header date) --}}
        <div class="page-header">
            <table class="header-table">
                <tr>
                    <td class="header-center" colspan="3">
                        <div class="header-logo-container" style="margin-bottom: 8px;">
                            @if ($showLogo && $logoSrc)
                                <img src="{{ $logoSrc }}" alt="Barangay Seal" class="header-logo">
                            @else
                                <div class="logo-placeholder">B</div>
        ...
        <div class="report-footer">
            <div>Date Generated: {{ $generated_date ?? date('F d, Y') }}</div>
        </div>
    @endif
</body>
