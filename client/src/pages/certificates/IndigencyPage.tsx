...
export default function IndigencyPage() {
  ...
  return (
    <div className="page-container">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h1 className="h3 mb-1 text-brand-primary">Certificate of Indigency</h1>
          <p className="text-brand-muted mb-0">Manage indigency certificate requests and issued documents</p>
        </div>
      </div>
        ...
        <Tab.Container activeKey={activeTab} onSelect={(k) => setActiveTab(k || 'requests')}>
          ...
          <Tab.Content>
            <Tab.Pane eventKey="requests">
              <CertificateRequests certificateType="indigency" />
            </Tab.Pane>
            <Tab.Pane eventKey="issued">
              <IssuedCertificates certificateType="indigency" />
            </Tab.Pane>
          </Tab.Content>
        </Tab.Container>
      </div>
