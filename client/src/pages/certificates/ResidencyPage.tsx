  ...
  return (
    <div className="page-container page-sub">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h2 className="h4 mb-1 text-brand-primary">Residency Certificate</h2>
          <p className="text-brand-muted mb-0">Manage residency certificate requests and issued documents</p>
        </div>
      </div>
        ...
        <Tab.Container activeKey={activeTab} onSelect={(k) => setActiveTab(k || 'requests')}>
          ...
          <Tab.Content>
            <Tab.Pane eventKey="requests">
              <CertificateRequests certificateType="residency" />
            </Tab.Pane>
            <Tab.Pane eventKey="issued">
              <IssuedCertificates certificateType="residency" />
            </Tab.Pane>
          </Tab.Content>
        </Tab.Container>
      </div>
